...
sos.base = {
    ...
    sliderGallery:function () {
     ...
     popTipReglogin : function () {
        function popReglogin () {
            $.pop({
                target: '.regloginPop',
                widthPer :0.9,
                maxW : 400
        ...
        if ($('.regloginPop').length==0) {
            $('body').append('<div class="regloginPop"><h3 class="h3-poptitle">您尚未登录或注册</h3>'+
                '<div class="tipRegloingWrap imgauto"><img src="images/popreglogin.jpg" height="242" width="516" alt="" /></div>'+
                '<p class="p-btn"><a class="col_6 btn-b bg-pink" href="login.html">马上登录</a><a class="col_6 btn-b bg-ink" href="reg.html">新客注册</a>'+
                '</div>');
            setTimeout(function () {
                popReglogin();
            },80);
    ...
    listEventBuy: function() { //产品列表点击弹窗采购信息
        ...
        //         pos: 'bottom',
        //         widthPer: 1,
        //         beforePop: function() {//打开pop之前
        //             beforePop();
        //         },
        //         closePop : function () {//关闭pop之时
